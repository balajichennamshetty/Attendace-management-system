...
window = tk.Tk()
window.title("BIOMETRIC BLISS Attendance Management System")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/91707/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/91707/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                timeStamp = datetime.datetime.fromtimestamp(
                    ts).strftime('%H:%M:%S')
                Hour, Minute, Second = timeStamp.split(":")
                fileName = "Attendance/Manually Attendance/" + Subject + "_" + date + "_" + Hour + "-" + Minute + "-" + Second + ".csv"
                attendance = attendance.drop_duplicates(
                    ['Enrollment'], keep='first')
                print(attendance)
                ...
                root.configure(background='grey80')
                cs = 'Face-Recognition-Attendance-System-main' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/91707/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'balaji':
            if password == 'balaji123':
                ...
                cs = 'C:/Users/91707/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Biometric Bliss", bg="purple", fg="white", width=50,
...
FA = tk.Button(window, text="Fill Attendance", fg="black", command=subjectchoose,
